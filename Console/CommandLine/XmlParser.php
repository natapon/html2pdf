...
class Console_CommandLine_XmlParser
{
    ...
    {
        if (is_dir('/usr/local/Cellar/php54/5.4.27/lib/php/data' . DIRECTORY_SEPARATOR . 'Console_CommandLine')) {
            $rngfile = '/usr/local/Cellar/php54/5.4.27/lib/php/data' . DIRECTORY_SEPARATOR
